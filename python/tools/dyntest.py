...
def dynamicSuite(rootDirectory, excludes=[]):
    """ Generates a dynamic suite out of the given directory.
    """
...
Default usage message."""
    ...
    parser.add_option('-d', '--dirname', action='store', dest='dirname',
            default='.', help="An alternative directory to test.")

    parser.add_option('--verbosity', '-v', action='store', type='int',
            dest='verbosity', default=1, help="How much detail to show.")
